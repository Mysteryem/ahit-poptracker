...
chapter_act_info = {
    ...
    TimeRift_Cave_Mafia = Act.new(-1, "TimeRift_Cave_Mafia", "Chapter Time Rift Entrances/Chapter1", "Mafia Town (HUMT)/Mafia of Cooks/Time Rift"),
    TimeRift_Water_Mafia_Easy = Act.new(-1,"TimeRift_Water_Mafia_Easy", "Chapter Time Rift Entrances/Chapter1", "Mafia Town (HUMT)/Sewers/Time Rift"),
    TimeRift_Water_Mafia_Hard = Act.new(-1,"TimeRift_Water_Mafia_Hard", "Chapter Time Rift Entrances/Chapter1", "Mafia Town (HUMT)/Bazaar/Time Rift"),
